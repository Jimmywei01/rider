      ...
      <section class="form_container">
        ...
        <el-form
          ...
          <el-form-item label="手機" prop="phone">
            <el-input v-model="registerUser.phone" placeholder="請輸入手機" type="phone"></el-input>
          </el-form-item>
          <el-form-item label="選擇身份" prop="identity">
            <el-select v-model="registerUser.identity" placeholder="請選擇身份">
              ...
              <el-option label="編輯" value="editor"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item>
...
import { validateName, validateEmail, validateIdentity, validatePass, validatePhone } from '@/utils/vaildate.js'
